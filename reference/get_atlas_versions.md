...
``` r
get_atlas_versions()
#> ℹ Downloading https://object-store.rc.nectar.org.au/v1/AUTH_06d6e008e3e642da99d806ba3ea629c5/cellNexus-metadata/atlas_versions.parquet to /tmp/RtmpPChTvp/atlas_versions.parquet
#> # A tibble: 5 × 5
